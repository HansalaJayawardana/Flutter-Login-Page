      ...
      child: Column(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Tab(icon: Image.asset("assets/images/facebooklogo2.png")),
              Tab(icon: Image.asset("assets/images/instagramlogo1.png")),
              Tab(icon: Image.asset("assets/images/linkedinlogo1.png")),
            ],
          )
        ],
      ),
